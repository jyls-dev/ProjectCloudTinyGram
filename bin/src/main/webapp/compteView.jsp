        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                <span class="navbar-logo">
                        <img src="https://s2.qwant.com/thumbr/0x380/d/0/52093700750598c1e9a2ee1515f52466361ce3d079d2f3a2f7a0518da90a26/timenote_logo_large.png?u=https%3A%2F%2Flecafedugeek.fr%2Fwp-content%2Fuploads%2F2016%2F06%2Ftimenote_logo_large.png&q=0&b=1&p=0&a=1" style="height: 3.8rem;">
            </div>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active col-md-2">
                    <p style="margin-top: 30px;"class="nav-item"><b>Profil Utilisateur</b></p>
                </li>
                <li class="nav-item active col-md-1">
                </li>
                <li class="nav-item dropdown col-md-3">
                    <p style="margin-top: 30px;" class="nav-item"><b>Nom : <%= connect.getNicknameUser() %> </b></p>
                </li>
                <li class="nav-item dropdown col-md-4">
                    <p style="margin-top: 30px;" class="nav-item">Mail : <%= connect.getEmailUser() %></p>
                </li>
                <li class="nav-item dropdown col-md-3">
                    <div style="margin-top: 20px;">
                        <a class="btn btn-outline-success my-2 my-sm-0" href="/deconnexion">Déconnexion</a>
                    </div>
                </li>
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2"><a href="/post.jsp"> Publier un Nouveau Post</a></h2>
...
<section class="mbr-section content4 cid-rX0kNznRqd" id="content4-2"></section>
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2"><a href="/view-post.jsp">Mes Posts</a></h2>
...
<section class="mbr-section content4 cid-rX0kNznRqd" id="content4-3"></section>
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2">Liste Utilisateurs à suivre </h2>
...
.cid-rX0kufkANT .nav-item:focus,
.cid-rX0kufkANT .nav-link:focus {
  outline: none;
}
.cid-rX0kufkANT .btn {
...
.cid-rX0kufkANT .collapsed .navbar-collapse.collapsing,
.cid-rX0kufkANT .collapsed .navbar-collapse.show {
...
@media (max-width: 991px) {
  ...
  .cid-rX0kufkANT .navbar-collapse.collapsing,
  .cid-rX0kufkANT .navbar-collapse.show {
    display: block !important;
  }
  .cid-rX0kufkANT .navbar-collapse.collapsing .navbar-nav,
  .cid-rX0kufkANT .navbar-collapse.show .navbar-nav {
    display: block;
    text-align: center;
  }
...
.cid-rX0kufkANT .nav-link:hover,
.cid-rX0kufkANT .dropdown-item:hover {
